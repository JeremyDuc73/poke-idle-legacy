...
const POKEMON_TYPES: Record<string, PokemonType> = {
  ...
  nidoranf: 'poison', nidorina: 'poison', nidoqueen: 'poison',
  nidoranm: 'poison', nidorino: 'poison', nidoking: 'poison',
  ...
  mrmime: 'psychic', scyther: 'bug',
  jynx: 'ice', electabuzz: 'electric', magmar: 'fire',
...
export function getPokemonType(slug: string): PokemonType {
  return POKEMON_TYPES[slug] ?? 'normal'
}
