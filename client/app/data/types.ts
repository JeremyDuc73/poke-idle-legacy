...
const POKEMON_TYPES: Record<string, PokemonType | [PokemonType, PokemonType]> = {
  ...
  'slowpoke-galar': 'psychic', 'slowbro-galar': ['poison', 'psychic'],
  'farfetchd-galar': 'fighting', 'weezing-galar': ['fairy', 'poison'],
  'mrmime-galar': ['ice', 'psychic'], 'corsola-galar': 'ghost',
  'zigzagoon-galar': ['dark', 'normal'], 'linoone-galar': ['dark', 'normal'],
  'darumaka-galar': 'ice', 'darmanitan-galar': 'ice',
  'yamask-galar': ['ground', 'ghost'], 'stunfisk-galar': ['ground', 'steel'],
  ...
  'typhlosion-hisui': ['fire', 'ghost'], 'qwilfish-hisui': ['dark', 'poison'],
  'sneasel-hisui': ['fighting', 'poison'], 'samurott-hisui': ['water', 'dark'],
  ...
  'avalugg-hisui': ['ice', 'rock'], 'decidueye-hisui': ['grass', 'fighting'],

  // === Paldean Forms ===
  'tauros-paldea': 'fighting',
  'tauros-paldeablaze': ['fighting', 'fire'],
  'tauros-paldeaaqua': ['fighting', 'water'],
