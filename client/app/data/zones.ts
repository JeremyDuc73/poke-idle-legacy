    ...
    zones: [
      {
        ...
        boss: {
          ...
          slug: 'cilan',
          team: [
            { nameFr: 'Manternel', nameEn: 'Leavanny', slug: 'leavanny', level: 78 },
            { nameFr: 'Fragilady', nameEn: 'Lilligant', slug: 'lilligant', level: 79 },
            { nameFr: 'Feuiloutan', nameEn: 'Simisage', slug: 'simisage', level: 80 },
          ],
          timerSeconds: 30,
        },
      },
      {
        ...
        boss: {
          ...
          slug: 'lenora',
          team: [
            { nameFr: 'Mastouffe', nameEn: 'Stoutland', slug: 'stoutland', level: 79 },
            { nameFr: 'Miradar', nameEn: 'Watchog', slug: 'watchog', level: 80 },
            { nameFr: 'Pashmilla', nameEn: 'Cinccino', slug: 'cinccino', level: 81 },
          ],
          timerSeconds: 35,
        },
      },
      {
        ...
        boss: {
          ...
          slug: 'burgh',
          team: [
            { nameFr: 'Brutapode', nameEn: 'Scolipede', slug: 'scolipede', level: 81 },
            { nameFr: 'Lançargot', nameEn: 'Escavalier', slug: 'escavalier', level: 82 },
            { nameFr: 'Crabaraque', nameEn: 'Crustle', slug: 'crustle', level: 83 },
          ],
          timerSeconds: 35,
        },
      },
      {
        ...
        boss: {
          ...
          slug: 'elesa',
          team: [
            { nameFr: 'Zéblitz', nameEn: 'Zebstrika', slug: 'zebstrika', level: 82 },
            { nameFr: 'Emolga', nameEn: 'Emolga', slug: 'emolga', level: 83 },
            { nameFr: 'Mygavolt', nameEn: 'Galvantula', slug: 'galvantula', level: 84 },
          ],
          timerSeconds: 35,
        },
      },
      {
        ...
        boss: {
          ...
          slug: 'clay',
          team: [
            { nameFr: 'Crocorible', nameEn: 'Krookodile', slug: 'krookodile', level: 84 },
            { nameFr: 'Minotaupe', nameEn: 'Excadrill', slug: 'excadrill', level: 85 },
            { nameFr: 'Crapustule', nameEn: 'Seismitoad', slug: 'seismitoad', level: 86 },
          ],
          timerSeconds: 40,
        },
      },
      {
        ...
        boss: {
          ...
          slug: 'skyla',
          team: [
            { nameFr: 'Déflaisan', nameEn: 'Unfezant', slug: 'unfezant', level: 85 },
            { nameFr: 'Rhinolove', nameEn: 'Swoobat', slug: 'swoobat', level: 86 },
            { nameFr: 'Lakmécygne', nameEn: 'Swanna', slug: 'swanna', level: 87 },
          ],
          timerSeconds: 40,
        },
      },
      {
        ...
        boss: {
          ...
          slug: 'brycen',
          team: [
            { nameFr: 'Polagriffe', nameEn: 'Beartic', slug: 'beartic', level: 86 },
            { nameFr: 'Sorbouboul', nameEn: 'Vanilluxe', slug: 'vanilluxe', level: 87 },
            { nameFr: 'Hexagel', nameEn: 'Cryogonal', slug: 'cryogonal', level: 88 },
          ],
          timerSeconds: 40,
        },
      },
      {
        ...
        boss: {
          ...
          slug: 'iris',
          team: [
            { nameFr: 'Drakkarmin', nameEn: 'Druddigon', slug: 'druddigon', level: 87 },
            { nameFr: 'Tranchodon', nameEn: 'Haxorus', slug: 'haxorus', level: 89 },
            { nameFr: 'Trioxhydre', nameEn: 'Hydreigon', slug: 'hydreigon', level: 90 },
          ],
          timerSeconds: 45,
        },
      },
      {
        ...
        boss: {
          ...
          slug: 'shauntal',
          team: [
            { nameFr: 'Tutankafer', nameEn: 'Cofagrigus', slug: 'cofagrigus', level: 89 },
            { nameFr: 'Moyade', nameEn: 'Jellicent', slug: 'jellicent', level: 90 },
            { nameFr: 'Golemastoc', nameEn: 'Golurk', slug: 'golurk', level: 91 },
            { nameFr: 'Lugulabre', nameEn: 'Chandelure', slug: 'chandelure', level: 92 },
            { nameFr: 'Mélancolux', nameEn: 'Lampent', slug: 'lampent', level: 89 },
          ],
          timerSeconds: 50,
        },
      },
      {
        ...
        boss: {
          ...
          slug: 'marshal',
          team: [
            { nameFr: 'Bétochef', nameEn: 'Conkeldurr', slug: 'conkeldurr', level: 90 },
            { nameFr: 'Judokrak', nameEn: 'Throh', slug: 'throh', level: 91 },
            { nameFr: 'Karaclée', nameEn: 'Sawk', slug: 'sawk', level: 91 },
            { nameFr: 'Shaofouine', nameEn: 'Mienshao', slug: 'mienshao', level: 92 },
            { nameFr: 'Baggaïd', nameEn: 'Scrafty', slug: 'scrafty', level: 93 },
          ],
          timerSeconds: 50,
        },
      },
      {
        ...
        boss: {
          ...
          slug: 'caitlin',
          team: [
            { nameFr: 'Mushana', nameEn: 'Musharna', slug: 'musharna', level: 91 },
            { nameFr: 'Sidérella', nameEn: 'Gothitelle', slug: 'gothitelle', level: 92 },
            { nameFr: 'Symbios', nameEn: 'Reuniclus', slug: 'reuniclus', level: 93 },
            { nameFr: 'Neitram', nameEn: 'Beheeyem', slug: 'beheeyem', level: 92 },
            { nameFr: 'Cryptéro', nameEn: 'Sigilyph', slug: 'sigilyph', level: 94 },
          ],
          timerSeconds: 50,
        },
      },
      {
        ...
        boss: {
          ...
          slug: 'grimsley',
          team: [
            { nameFr: 'Léopardus', nameEn: 'Liepard', slug: 'liepard', level: 92 },
            { nameFr: 'Zoroark', nameEn: 'Zoroark', slug: 'zoroark', level: 93 },
            { nameFr: 'Baggaïd', nameEn: 'Scrafty', slug: 'scrafty', level: 93 },
            { nameFr: 'Scalproie', nameEn: 'Bisharp', slug: 'bisharp', level: 94 },
            { nameFr: 'Vaututrice', nameEn: 'Mandibuzz', slug: 'mandibuzz', level: 95 },
          ],
          timerSeconds: 50,
        },
      },
      {
        ...
        boss: {
          ...
          slug: 'alder',
          team: [
            { nameFr: 'Darumacho', nameEn: 'Darmanitan', slug: 'darmanitan', level: 93 },
            { nameFr: 'Gueriaigle', nameEn: 'Braviary', slug: 'braviary', level: 93 },
            { nameFr: 'Minotaupe', nameEn: 'Excadrill', slug: 'excadrill', level: 94 },
            { nameFr: 'Noacier', nameEn: 'Ferrothorn', slug: 'ferrothorn', level: 95 },
            { nameFr: 'Frison', nameEn: 'Bouffalant', slug: 'bouffalant', level: 96 },
            { nameFr: 'Pyrax', nameEn: 'Volcarona', slug: 'volcarona', level: 98 },
          ],
          timerSeconds: 60,
        },
      },
